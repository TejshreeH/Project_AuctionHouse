/*******************************************************************************************************************
 * * FILE NAME : AuctionHouse_Bidder_Func.c 
 *
 *
 * * DESCRIPTION : This file contains all the functions related to Bidder details and displaying Bidder reports
 *
 *
 * * FUNCTION NAME : add_bidder(), edit_bidder(), del_bidder(), view_bidder(), display_bidding_report()
 *
*******************************************************************************************************************/
...
#include "auctionheader.h"
			...
			/********************** add_bidder() 
		 		 Adds Bidder details to the Reg_Bidder file *******************/
...

{
	...
	while(1)
	{
		...
		/************************** view_bidder()
  			Display the  Bidder details from  Reg_Bidder file ***********************/
...
int view_bidder()
{
	...
	else
	{
		...
		/************************* edit_bidder() 
 			Edit the  Bidder details from  Reg_Bidder file ****************************/
...

{
	...
	if(ptr1==NULL)
	{
		...
		return(1);
			...
			/*********************** del_bidder()
 				 Delete the  Bidder details from  Reg_Bidder file ***********************/
...
int del_bidder()
{
	...
	else
	{
		...
		/************************ display_bidding_report()
 					 displays the winner details ***********************************/

...
/****************************add_item() Adds Item details to the Item_to_be_auctioned file**************************/
...
/*************************************edit_item() Edit Item details from the Item_to_be_auctioned file********************************************/
...
/*************************************del_item() Deletes Item details from the Item_to_be_auctioned file******************************************/
...
/*************************************view_item() Displays Item details from the Item_to_be_auctioned file****************************************/
